		...
		return (
			<div className='container'>
				...
				<div className='profile-stats clearfix'>
					<ul>
						<li className='col-sm-4'><span className='stats-number'>{this.state.winLossRatio}</span>Winning Percentage</li>
						<li className='col-sm-4'><span className='stats-number'>{this.state.wins}</span> Wins</li>
						<li className='col-sm-4'><span className='stats-number'>{this.state.losses}</span> Losses</li>
					</ul>
				</div>
			</div>
		);
